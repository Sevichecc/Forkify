...
const controlRecipes = async function() {
    try {
        ...
        _recipeViewJsDefault.default.renderErr(`${err}💥💥💥💥`);
    }
};
// 搜索
...
const controlAddRecipe = async function(newRecipe) {
    try {
        ...
        // console.log(err);
        _addRecipeViewJsDefault.default.renderErr(err.message);
    }
};
// subscriber,和view链接
const init = function() {
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== ''
            ...
            if (ingArr.length !== 3) throw new Error('Wrong ingredien format! Please try again');
...
},{"./config.js":"k5Hzs","./helper.js":"lVRAz","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lVRAz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
class RecipeView extends _viewJsDefault.default {
    ...
    _errMessage = 'Sorry,We could not find the recipe 😥';
    _message = '';
    // Publisher,将controler中需要的部分作为参数导入
    ...
    _generateMarkupIngredient(ing) {
      ...
      <li class="recipe__ingredient">
        ...
        <div class="recipe__quantity">${ing.quantity ? new _fractyDefault.default(ing.quantity).toString() : ''}</div>
...
},{"url:../../img/icons.svg":"loVOp","./View.js":"5cUXS","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","fracty":"hJO4d"}],"loVOp":[function(require,module,exports) {
...
class View {
    ...
    render(data, render = true) {
        if (!data || Array.isArray(data) && data.length === 0) return this.renderErr();
        this._data = data;
...
class PaginationView extends _viewJsDefault.default {
    ...
    _generateMarkup() {
        ...
        let markup;
        // 首页
        if (curPage === 1 && numPage > 1) markup = this._generateMarkupBtnNext(curPage);
        else if (curPage === numPage && numPage > 1) //最后一页
        markup = this._generateMarkupBtnPre(curPage);
        else if (curPage < numPage) //中间的页面
        markup = this._generateMarkupBtnNext(curPage).concat(this._generateMarkupBtnPre(curPage));
        else markup = '';
        // Last page
...
class BookmarksView extends _viewJsDefault.default {
    ...
    _errMessage = 'No Bookmark yet.Find a nice recipe and bookmarked it ;) ';
    _message = '';
    addHandlerRender(handler) {
...
class addRecipeView extends _viewJsDefault.default {
    ...
    constructor(){
        super();
        this._addHandlerShowWindow(); // 点击按钮立即执行
        this._addHandlerHideWindow(); // 点击外面的模态立即执行
    }
    toggleWindow() {
